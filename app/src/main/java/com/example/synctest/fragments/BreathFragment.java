...
public class BreathFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendBreathInformation(selectedCardioRadio, selectedAedRadio, selectedRecoveryRadio);
    ...
    private void sendBreathInformation(final String cardiopulmonary, String aed, String recovery) {
